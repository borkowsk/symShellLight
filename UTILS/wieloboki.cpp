...
#include <cstring> //Bo musimy/chcemy u�y� funkcji "memcpy" - kopiowania pami�ci i strcmp
#include <ctype.h> //Nazwy wielobok�w maj? by? NON CASE SENSITIVE
...
static ssh_point kLudzik1[]= //Prawie r�wnie bezp�ciowy
...
//Definijemy obiekty dla przyk�adowych kszta�t�w - jest ich w sumie niewiele
...
//Wlasciwa biblioteka podstawowych kszta�t�w w przestrzeni nazw klasy Wielobok,
////////////////////////////////////////////////////////////////////////////////
struct ElementListy
...
//Zrobione jako statyczne metody bo to pozwala robic potem r�ne implementacje
//przechowywania tych wielobok�w, np. tworzyc je dopiero gdy b?d? potrzebne
//lub �ci�ga� z dysku.
