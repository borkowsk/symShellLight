...
// <summary>
// Usuwa item z menu. Item może być identyfikowany wg. pozycji, albo wg. komendy którą generuje (liczby z zakresu 0-FFFF)
// </summary>
...
// <summary>
// Wymusza pojawienie się uprzednio zdefiniowanego lub zmodyfikowanego menu.
// </summary>
