...
// !!!:	Zawartosc jest "sztefetowana" pomiedzy obiektami powyższych typów -
...
void finalise(){ dispose(); }//Wywolanie rownoważne destruktorowi
...
//Kontrole zakresow itp assercje dziedziczy po klasie macieżystej
template<class T>
